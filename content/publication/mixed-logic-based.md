...
math = true
publication_types = ["1"]
publication = "In *the 28th European Conference on Operational Research (EURO 2016). Poznan, Poland, 2016*, ECOR."
publication_short = "In *ECOR*"
selected = false
title = "Mixed logit-based stochastic dynamic user equilibrium"
url_code = "#"
url_dataset = ""
url_pdf = ""
url_project = ""
